...
def submain():
    ...
    from procedural_city_generation.building_generation.building_tools import Polygon3D, verticalsplit, buildledge, \
        buildwalls, get_windows
    ...
    for poly in polylist:
        ...
        if poly.poly_type == "road":
            ...
            if housebool:
                ...
                windowdist = np.random.uniform(singleton.windowdist_min_not_house,
            ...
            for element in plan:
                if element == 'b' or element == 'f':
                    ...
                    if ledgefactor == 1:
                        polygons.extend(roof(walls, roofwalls, currentheight, housebool, rooftexture,
