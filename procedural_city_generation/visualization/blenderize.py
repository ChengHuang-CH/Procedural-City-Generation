...
def createtexture(name, scale, texturetype='REPEAT'):
    ...
    print(f'load image from {path + "/visualization/Textures/" + name}')
    imagenode.image = bpy.data.images.load(path + "/visualization/Textures/" + name)
    imagenode.projection = 'BOX'

    # print(f'keys: {mat.node_tree.nodes.keys()}')
    #  keys: ['Principled BSDF', 'Material Output', 'Image Texture']
    ...
    # # print(f'attr:{mat.node_tree.nodes.__dir__()}')
