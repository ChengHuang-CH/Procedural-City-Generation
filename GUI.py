...
class GUI(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        """
        create the folder path when it is not existing (avoid issue on Windows)
        """
        if not os.path.isdir(os.getcwd() + "/procedural_city_generation/temp/"):
            os.mkdir(os.getcwd() + "/procedural_city_generation/temp/")
            print(f'create folder: {os.getcwd() + "/procedural_city_generation/temp/"}')

        if not os.path.isdir(os.getcwd() + "/procedural_city_generation/outputs/"):
            os.mkdir(os.getcwd() + "/procedural_city_generation/outputs/")
            print(f'create folder: {os.getcwd() + "/procedural_city_generation/outputs/"}')
